...
define ComposerSquadEveningJazz = AudioCredits(
    "Evening Jazz",
    "Composer Squad",
    "audio/music/Erotic/Evening Jazz.wav",
    "",
    "",
    "",
    "",
...
define ComposerSquadFeelMe = AudioCredits(
    "Feel Me",
    "Composer Squad",
    "audio/music/Erotic/Feel Me.wav",
    "",
    "",
    "",
    "",
...
define ComposerSquadNaughtySecrets = AudioCredits(
    "Naughty Secrets",
    "Composer Squad",
    "audio/music/Erotic/Naughty Secrets.wav",
    "",
    "",
    "",
    "",
...
define ComposerSquadNightLover = AudioCredits(
    "Night Lover",
    "Composer Squad",
    "audio/music/Erotic/Night Lover.wav",
    "",
    "",
    "",
    "",
...
define ComposerSquadPleasure = AudioCredits(
    "Pleasure",
    "Composer Squad",
    "audio/music/Erotic/Pleasure.wav",
    "",
    "",
    "",
    "",
...
define pixad0_sad = AudioCredits(
    "Sad",
    "Pixabay",
    "audio/music/Pilot/d0_sad.mp3",
    "",
    "",
    "",
    "",
...
define pixad1_hospital = AudioCredits(
    "Hospital",
    "Pixabay",
    "audio/music/Pilot/d1_hospital.mp3",
    "",
    "",
    "",
    "",
...
define pixad1_night_forest = AudioCredits(
    "Night Forest",
    "Pixabay",
    "audio/music/Pilot/d1_night_forrest.mp3",
    "",
    "",
    "",
    "",
...
define pixad1_night_home = AudioCredits(
    "Night Home",
    "Pixabay",
    "audio/music/Pilot/d1_night_home.mp3",
    "",
    "",
    "",
    "",
...
define pixad1_police = AudioCredits(
    "Police",
    "Pixabay",
    "audio/music/Pilot/d1_police.mp3",
    "",
    "",
    "",
    "",
...
define pixad2_arrival = AudioCredits(
    "Arrival",
    "Pixabay",
    "audio/music/Pilot/d2_arrival.mp3",
    "",
    "",
    "",
    "",
...
define pixad2_healing = AudioCredits(
    "Healing",
    "Pixabay",
    "audio/music/Pilot/d2_healing.mp3",
    "",
    "",
    "",
    "",
...
define pixad2_morning = AudioCredits(
    "Morning",
    "Pixabay",
    "audio/music/Pilot/d2_morning.mp3",
    "",
    "",
    "",
    "",
...
define RadioMusic = AudioCredits(
    "Here, With You",
    "Tree Star Moon",
    "audio/music/Radio/Radio.mp3",
    "",
    "",
    "",
    "",
...
define pixad5_aurora = AudioCredits(
    "Aurora",
    "Pixabay",
    "audio/music/d5_aurora.mp3",
    "",
    "",
    "",
    "",
...
define pixad5_training = AudioCredits(
    "Training",
    "Pixabay",
    "audio/music/d5_training.mp3",
    "",
    "",
    "",
    "",
...
define pixad7_lucy = AudioCredits(
    "Lucy",
    "Pixabay",
    "audio/music/d7_lucy.mp3",
    "",
    "",
    "",
    "",
...
define pixad7_reunion = AudioCredits(
    "Reunion",
    "Pixabay",
    "audio/music/d7_reunion.mp3",
    "",
    "",
    "",
    "",
...
define pixad9_megan = AudioCredits(
    "Megan",
    "Pixabay",
    "audio/music/d9_megan.mp3",
    "",
    "",
    "",
    "",
...
init -1000 python:
    ...
    def music_dur(style_name, size, yalign, st, at):
        ...
        if renpy.music.is_playing(channel="music"):
            try:
                time_duration = get_music_len(mr.get_track(), False) or time_duration
            except:
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            audio = WAVE(file)  # Handle WAV using Mutagen's WAVE class
                        except Exception:
                            try:
                                audio = OggOpus(file)
                            except Exception as e:
            ...
            for track in tracks:
                if track[1] == correction:
                    if track[0] != audio.filename:
                        ...
                        break
            data.append([audio.title, audio.artist, audio.filename])
